  ...
  <div class="container">
    <div class="row d-flex justify-content-around align-items-center min-vh-100">
      ...
      <div class="d1 col-md-6">
        ...
        <div class="mb-2">
            <label for="exampleFormControlInput1" class="form-label text-light">Full Name</label>
            <div class="field-group">
              <input type="email" class="form-control rounded-pill" id="exampleFormControlInput1" placeholder="Full Name">
              <div class="icon">
