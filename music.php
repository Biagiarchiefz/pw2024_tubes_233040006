  ...
  <header class="">
    ...
    <div class="lagu overflow-auto rounded-4 border-bottom border-5 border-dark ">
      ...
      <div class="content m-auto pt-3">
       ...
       <div class="card me-3 bg-dark border border-dark"  style="width: 300px;">
        <div class="d-flex ">
          <img src="img/2.jpeg" alt="" style=" width: 40px; padding: 2px;" class="rounded">
          <p class="ms-2 mt-2 fw-bold">Lorem ipsum</p>
        </div>
       </div>
